...
interaction_descriptions = {
    ...
    "mixer_ScienceTable_Empty": {
        "pre_actions": [
            "{initiator} is preparing a scientific experiment with {target} using an empty flask."
        ]
    },
    "mixer_Social_GetToKnow_Friendly_STC": {
        "pre_actions": [
            "{initiator} is asking {target} to talk to about themselves."
        ]
    },
    "mixer_social_AttemptToScare_targeted_mischief_skills": {
        "pre_actions": [
            "{initiator} is jump scaring {target}."
        ]
    },
    ...
    "mixer_social_DoAnImpression_targeted_funny_alwaysOn": {
        "pre_actions": [
            "{initiator} is doing a hilarious impression for {target}."
        ]
    },
    ...
    "mixer_social_BoldPickUpLine_targeted_romance_emotionSpecific": {
        "pre_actions": [
            "{initiator} confidently presents a bold pick-up line to {target} to ignite romance."
        ]
    },
    ...
    "mixer_social_MakeAFlirtatiousJoke_targeted_romance_emotionSpecific": {
        "pre_actions": [
            "{initiator} is playfully making a flirtatious joke with {target}."
        ]
    },
    ...
    "mixer_social_TellDirtyJoke_targeted_funny_emotionSpecific": {
        "pre_actions": [
            "{initiator} is reciting a dirty joke to {target}. {target} is listening as {initiator} begins."
        ]
    },
    "mixer_social_FlashCrazyEyes_targeted_funny_emotionSpecific": {
        "pre_actions": [
            "{initiator} is playfully flashing crazy eyes at {target}."
        ]
    },
    ...
    "mixer_social_AskForAdvice_targeted_friendly_emotionSpecific": {
        "pre_actions": [
            "{initiator} is asking {target} for advice."
        ]
    },
    "mixer_social_ProposeCrazyScheme_targeted_friendly_emotionSpecific": {
        "pre_actions": [
            "{initiator} is proposing a crazy scheme to {target}."
        ]
    },
    ...
    "mixer_social_Apologize_targeted_friendly_lowScore": {
        "pre_actions": [
            "{initiator} is apologizing to {target}."
        ]
    },
    ...
    "mixer_social_WooHoo_targeted_romance_transition": {
        "pre_actions": [
            "{initiator} is taking {target}'s hand to go have sex in the bedroom."
        ]
    },
    "mixer_social_WooHooInRocketShip_targeted_romance_transition": {
        "pre_actions": [
            "{initiator} is leading {target} to the rocket ship to go have sex."
        ]
    },
    "mixer_social_WooHooInObservatory_targeted_romance_transition": {
        "pre_actions": [
            "{initiator} is leading {target} to the Observatory to go have sex."
        ]
    },
    "mixer_social_TryForBaby_targeted_romance_transition": {
        "pre_actions": [
            "{initiator} is beginning a conversation about trying to have a baby with {target}."
        ]
    },
    ...
    "mixer_social_BegForgiveness_targeted_friendly_lowScore": {
        "pre_actions": [
            "{initiator} is begging for {target}'s forgiveness."
        ]
    },
    ...
    "mixer_social_ComplimentAppearance_targeted_romance_alwaysOn": {
        "pre_actions": [
            "{initiator} is beginning complimenting {target} on their appearance."
        ]
    },
    ...
    "mixer_social_RememberCommonInterests_targeted_romance_lowScore": {
        "pre_actions": [
            "{initiator} is discussing with {target} to remember their common interests as romantic partners."
        ]
    },
    ...
    "mixer_socials_TellFunnyStory_group_Funny_alwaysOn": {
        "pre_actions": [
            "{initiator} is telling a funny story to {target}."
        ]
    },
    "mixer_socials_GoofAround_targeted_Funny_alwaysOn": {
        "pre_actions": [
            "{initiator} is playfully goofing around with {target}."
        ]
    },
    "mixer_social_TellOutrageousStory_group_Funny_HighScore": {
        "pre_actions": [
            "{initiator} is telling an outrageous story to {target}."
        ]
    },
    ...
    "mixer_social_SitIntimate_MakeOut_targeted_romance_highScore": {
        "pre_actions": [
            "{initiator} is sitting with {target} and passionately making out with them."
        ]
    },
    ...
    "mixer_social_SitIntimate_TickleMercilessly_targeted_romance_middleScore": {
        "pre_actions": [
            "{initiator} is sitting with {target} and tickling them mercilessly."
        ]
    },
    "mixer_social_SitIntimate_MakeAMove_targeted_looping": {
        "pre_actions": [
            "{initiator} is making a romantic move towards {target} while sitting together."
        ]
    },
    ...
    "mixer_social_InstillWithFalseConfidence_targeted_mischief_skills": {
        "pre_actions": [
            "{initiator} is instilling false confidence into {target} with a mischievous motive."
        ]
    },
    ...
    "mixer_social_RevealDeepSecret_targeted_Friendly_HighScore": {
        "pre_actions": [
            "{initiator} is beginning to share a treasured memory they remember to {target}."
        ]
    },
    ...
    "mixer_social_EnthuseAboutSpace_targeted_friendly_alwaysOn_career": {
        "pre_actions": [
            "{initiator} is beginning to enthuse about space to {target}."
        ]
    },
    ...
    "mixer_social_DiscussWorldPeace_targeted_Friendly_alwaysOn": {
        "pre_actions": [
            "{initiator} is discussing world peace with {target}."
        ]
    },
    ...
    "mixer_socail_DiscussFearOfCommitment_targeted_romance_alwaysOn": {
        "pre_actions": [
            "{initiator} is discussing their fear of commitment with {target}."
        ]
    },
    ...
    "mixer_social_TalkAboutCooking_targeted_Friendly_alwaysOn_skills": {
        "pre_actions": [
            "{initiator} is beginning to enthuse about the hobby of cooking to {target}."
        ]
    },
    ...
    "mixer_social_RepayLoanSmall_targeted_Friendly_alwaysOn": {
        "pre_actions": [
            "{initiator} is repaying a small loan to {target}."
        ]
    },
    ...
    "mixer_social_TalkAboutDrinkMaking_targeted_Friendly_alwaysOn_skills": {
        "pre_actions": [
            "{initiator} is engaging in a friendly conversation with {target} about mixology."
        ]
    },
    ...
    "mixer_social_TryOutMaterial_targeted_funny_alwaysOn": {
        "pre_actions": [
            "{initiator} is playfully trying out a new material with {target}."
        ]
    },
    ...
    "mixer_social_KnockKnockJoke_targeted_funny_alwaysOn_skills": {
        "pre_actions": [
            "{initiator} is telling a knock knock joke to {target}. {target} is listening as {initiator} begins."
        ]
    },
    ...
    "mixer_social_JokeAboutFashion_targeted_funny_alwaysOn_Skills": {
        "pre_actions": [
            "{initiator} is beginning to tell a joke about fashion to {target}."
        ]
    },
    ...
    "mixer_social_SecretVillainHandshake_targeted_mean_alwaysOn_career": {
        "pre_actions": [
            "{initiator} is doing a secret villain handshake with {target}."
        ]
    },
    ...
    "mixer_social_HilariousIcebreaker_greetings": {
        "pre_actions": [
            "{initiator} is using a hilarious greeting with {target} to break the ice."
        ]
    },
    "mixer_social_FunniestJokeInTheWorld_group_Funny_HighScore": {
        "pre_actions": [
            "{initiator} is sharing the funniest joke in the world with {target}."
        ]
    },
    "mixer_social_ComplainAboutBills_targeted_Friendly_alwaysOn_bills": {
        "pre_actions": [
            "{initiator} is complaining to {target} about the high cost of bills."
        ]
    },
    "mixer_social_ComplainAboutLackOfWater_targeted_friendly_alwaysOn_bills": {
        "pre_actions": [
            "{initiator} is expressing frustration to {target} about the lack of water due to {initiator}'s unpaid water bill."
        ]
    },
    "mixer_social_ComplainAboutLackOfPower_targeted_friendly_alwaysOn_billsLack": {
        "pre_actions": [
            "{initiator} is voicing their frustration to {target} about the lack of power due to {initiator}'s unpaid water bill."
        ]
    },
    "mixer_social_SitIntimate_Cuddle_targeted_friendly_alwaysOn": {
        "pre_actions": [
            "{initiator} is sitting and cuddling {target}."
        ]
    },
    ...
    "mixer_social_WeaponizedJoke_targeted_funny_alwaysOn": {
        "pre_actions": [
            "{initiator} is telling a weaponized joke to {target}."
        ]
    },
    "mixer_social_HorrifyingJoke_targeted_funny_alwaysOn": {
        "pre_actions": [
            "{initiator} is telling a horrifying joke to {target}."
        ]
    },
    ...
    "mixer_social_SitIntimate_WooHoo_targeted_romance_HighScore": {
        "pre_actions": [
            "{initiator} is sitting and asking {target} if they want to go have sex."
        ]
    },
    "mixer_social_SitIntimate_TryForBaby_targeted_romance_HighScore": {
        "pre_actions": [
            "{initiator} is sitting and asking {target} if they want to have a baby together."
        ]
    },
    "mixer_social_OfferFriendlyMassage_targeted_Friendly_MiddleScore": {
        "pre_actions": [
            "{initiator} is asking {target} if they want a massage."
        ]
    },
    ...
    "mixer_social_BegForNewToys_targeted_friendly_alwaysOn_child": {
        "pre_actions": [
            "{initiator} is begging {target} to buy new toys."
        ]
    },
    ...
    "mixer_social_TellJoke_group_Funny_alwaysOn_child": {
        "pre_actions": [
            "{initiator} is telling a funny joke to {target} and anyone else listening."
        ]
    },
    ...
    "mixer_social_MakeSillyFace_targeted_funny_alwaysOn_child": {
        "pre_actions": [
            "{initiator} is making a silly face at {target}."
        ]
    },
    "mixer_social_TellGrossJoke_group_funny_MediumScore_child": {
        "pre_actions": [
            "{initiator} is telling a potty joke to {target}."
        ]
    },
    ...
    "mixer_social_MonkeyAround_targeted_mischief_alwaysOn_child": {
        "pre_actions": [
            "{initiator} is playfully starting to monkey around with {target}."
        ]
    },
    ...
    "mixer_social_AskAboutSchool_targeted_friendly_alwaysOn_child": {
        "pre_actions": [
            "{initiator} is asking {target} about how school was."
        ]
    },
    ...
    "mixer_social_AskAboutWooHoo_targeted_Friendly_alwaysOn_teen": {
        "pre_actions": [
            "{initiator} is asking {target} about sex."
        ]
    },
    ...
    "mixer_social_AskAboutBeingOld_targeted_Friendly_alwaysOn_child": {
        "pre_actions": [
            "{initiator} is asking {target} about the experience of being old."
        ]
    },
    ...
    "mixer_social_ComplainAboutEverything_targeted_Friendly_alwaysOn_teen": {
        "pre_actions": [
            "{initiator} is expressing their discontent about everything to {target}, venting their frustrations and sharing their grievances."
        ]
    },
    ...
    "mixer_social_ComplainAboutLocalYouths_targeted_friendly_alwaysOn_neighbor": {
        "pre_actions": [
            "{initiator} is complaining to {target}, their neighbor, about the behavior of some local youths."
        ]
    },
    "mixer_social_DiscussNeighborhoodChanges_targeted_friendly_alwaysOn_neighbor": {
        "pre_actions": [
            "{initiator} is discussing recent changes in the neighborhood with {target}."
        ]
    },
    "mixer_social_ChatAboutPropertyVaules_targeted_friendly_alwaysOn_neighbor": {
        "pre_actions": [
            "{initiator} is discussing property values with {target}."
        ]
    },
    "mixer_social_DiscussLocalFishingSpots_targeted_friendly_alwaysOn_neighbor": {
        "pre_actions": [
            "{initiator} is discussing local fishing spots with {target}."
        ]
    },
    "mixer_social_ComplimentHouse_targeted_friendly_alwaysOn_neighbor": {
        "pre_actions": [
            "{initiator} is complimenting {target}'s house."
        ]
    },
    "mixer_social_InsultHouse_targeted_mean_alwaysOn_neighbor": {
        "pre_actions": [
            "{initiator} is making a mean comment about {target}'s house."
        ]
    },
    ...
    "mixer_social_ComplainAboutClasses_targeted_Friendly_alwaysOn_child_teen": {
        "pre_actions": [
            "{initiator} is complaining about classes to {target}."
        ]
    },
    ...
    "mixer_social_QuoteCartoonCharacter_targeted_Funny_alwaysOn_child": {
        "pre_actions": [
            "{initiator} is impersonating a funny cartoon character to {target}."
        ]
    },
    ...
    "mixer_social_AskWhatHappened_targeted_Friendly_alwaysOn": {
        "pre_actions": [
            "{initiator}, with a friendly concern, is asking {target} what happened."
        ]
    },
    ...
    "mixer_Social_Sim_Ghost_Ask_About_Being_Dead": {
        "pre_actions": [
            "{initiator} is asking {target} what it's like to be a dead ghost."
        ]
    },
    ...
    "mixer_social_OffertoPumpup_targeted_Friendly_Athlete_AlwaysOn_STC": {
        "pre_actions": [
            "{initiator} is offering to pump up {target}."
        ]
    },
    ...
    "mixer_social_WooHooInHottub_targeted_romance_transition": {
        "pre_actions": [
            "{initiator} and {target} are sneaking into the hot tub to have sex together."
        ]
    },
    ...
    "mixer_social_WooHooinHotTub_targeted_Stand_romance_transition": {
        "pre_actions": [
            "{initiator} and {target} are engaging in a passionate sex session in the hot tub, their romantic feelings are transitioning to a new level."
        ]
    },
    ...
    "mixer_social_ComplainAboutLackofLoveLife_Targeted_Friendly_AlwaysOn_Jealous_Trait": {
        "pre_actions": [
            "{initiator} is venting to {target} about their lack of a love life."
        ]
    },
    ...
    "mixer_AskToSpray_MonsterUnder_Bed": {
        "pre_actions": [
            "{initiator} is asking {target} to spray for the monster under the bed to keep it away."
        ]
    },
    ...
    "mixer_social_Toddler_Friendly_TalkTo_Stranger": {
        "pre_actions": [
            "{initiator} is engaging in a friendly conversation with a stranger, {target}."
        ]
    },
    ...
    "mixer_social_BrightenDay_targeted_friendly_emotionSpecific_toddlerOnly": {
        "pre_actions": [
            "{initiator} is trying to brighten {target}'s day."
        ]
    },
    ...
    "mixer_social_AskForAdvice_targeted_friendly_emotionSpecific_Scared": {
        "pre_actions": [
            "{initiator} is scaredly asking {target} for advice."
        ]
    },
    ...
    "mixer_social_DiscussExpandingTheFamily_Targeted_Friendly_AlwaysOn": {
        "pre_actions": [
            "{initiator} is discussing having a baby with {target}."
        ]
    },
    ...
    "mixer_social_Targeted_Friendly_DiscussFears": {
        "pre_actions": [
            "{initiator} is discussing their fears with {target}."
        ]
    },
    ...
    "mixer_social_WhereDidTheMoonGo_Friendly_alwaysOn_child_skills": {
        "pre_actions": [
            "{initiator} is innocently asking {target} where moon went."
        ]
    },
    ...
    "mixer_Social_SexualOrientation_AskAboutWooHooInterests": {
        "pre_actions": [
            "{initiator} is asking {target} about their interests in sex, in a social and curious manner."
        ]
    },
    "mixer_Social_SexualOrientation_AskToBeWooHooPartners": {
        "pre_actions": [
            "{initiator} is asking {target} if they would like to become sexual partners, hinting at a potential intimate relationship."
        ]
    },
    "mixer_Social_SexualOrientation_EndWooHooPartners": {
        "pre_actions": [
            "{initiator} and {target} are agreeing to end their sexual relationship, deciding to remain friends instead."
        ]
    },
    ...
    "mixer_Social_Targeted_Friendly_Loyal_ConfessTrashTalk": {
        "pre_actions": [
            "{initiator} is confessing to {target} that they talked trash about them and wanted to amend things."
        ]
    },
    ...
    "mixer_Social_Targeted_Romance_Loyal_RebuildTrust": {
        "pre_actions": [
            "{initiator} is rebuilding the trust in their romantic relationship with {target} after infidelity."
        ]
    },
    ...
    "mixer_social_DiscussAddingLog_targeted_friendly_situation_GP01": {
        "pre_actions": [
            "{initiator} is discussing with {target} adding a log to the property."
        ]
    },
    "mixer_social_ComplainAboutMosquitoes_targeted_Friendly_situation_GP01": {
        "pre_actions": [
            "{initiator} is complaining about the mosquitos to {target}."
        ]
    },
    ...
    "mixer_social_AskAboutCamping_targeted_Friendly_alwaysOn": {
        "pre_actions": [
            "{initiator} is asking {target} about camping."
        ]
    },
    ...
    "mixer_social_AskPolitelyForInformation_InterrogationTable_GoodCop": {
        "pre_actions": [
            "{initiator} is using a good cop approach and politely asking {target} for information at the interrogation table."
        ]
    },
    "mixer_social_DiscussVictim_InterrogationTable_GoodCop": {
        "pre_actions": [
            "{initiator} is using a good cop approach and discussing the victim with {target} at the interrogation table."
        ]
    },
    "mixer_social_DiscussPleaDeal_InterrogationTable_GoodCop": {
        "pre_actions": [
            "{initiator} is using a good cop approach and discussing a plea deal with {target} at the interrogation table."
        ]
    },
    "mixer_social_AskAboutCrime_InterrogationTable_GoodCop": {
        "pre_actions": [
            "{initiator} is using a good cop approach and asking {target} about the crime at the interrogation table."
        ]
    },
    "mixer_social_TellPersonalStory_InterrogationTable_GoodCop": {
        "pre_actions": [
            "{initiator} is using a good cop approach and telling a personal story to {target} at the interrogation table."
        ]
    },
    "mixer_social_PretendToBeFriends_InterrogationTable_GoodCop": {
        "pre_actions": [
            "{initiator} is using a good cop approach and pretending to be friends with {target} at the interrogation table."
        ]
    },
    "mixer_social_DescribePrisonHorrors_InterrogationTable_GoodCop": {
        "pre_actions": [
            "{initiator} is using a good cop approach and describing the horrors of prison to {target} at the interrogation table."
        ]
    },
    "mixer_social_MakeFalsePromises_InterrogationTable_GoodCop": {
        "pre_actions": [
            "{initiator} is using a good cop approach and making flakes promises to {target} at the interrogation table."
        ]
    },
    "mixer_social_OfferCandyBar_InterrogationTable_GoodCop": {
        "pre_actions": [
            "{initiator} is using a good cop approach and offering a candy bar to {target} at the interrogation table."
        ]
    },
    "mixer_social_PromiseTastyMeal_InterrogationTable_GoodCop": {
        "pre_actions": [
            "{initiator} is using a good cop approach and promising {target} a tasty meal as they are sitting at the interrogation table."
        ]
    },
    "mixer_social_PretendToCheckPhone_InterrogationTable_GoodCop": {
        "pre_actions": [
            "{initiator} is using a good cop approach and pretending to check their phone while they secretly observe {target}."
        ]
    },
    "mixer_social_SlamCaseFile_InterrogationTable_BadCop_Emotion": {
        "pre_actions": [
            "{initiator} is using a bad cop approach and slamming the case files down on the table in front of {target}."
        ]
    },
    "mixer_social_AskStressfulRiddles_InterrogationTable_BadCop_Emotion": {
        "pre_actions": [
            "{initiator} is using a bad cop approach and asking stressful riddles to {target}."
        ]
    },
    "mixer_social_Intimidate_InterrogationTable_BadCop_": {
        "pre_actions": [
            "{initiator} is using a bad cop approach and is intimidating {target}."
        ]
    },
    "mixer_social_AskTrickQuestion_InterrogationTable_BadCop_Emotion": {
        "pre_actions": [
            "{initiator} is using a bad cop approach and is asking trick questions to {target}."
        ]
    },
    "mixer_social_ThreatenWithSpiders_InterrogationTable_BadCop": {
        "pre_actions": [
            "{initiator} is using a bad cop approach and is menacingly waving a jar of spiders in front of {target}."
        ]
    },
    "mixer_social_ThreatenWithTickleTorture_InterrogationTable_BadCop": {
        "pre_actions": [
            "{initiator} is using a bad cop approach and threating to torture {target} with tickles."
        ]
    },
    "mixer_social_TellStoryAboutPrison_InterrogationTable_BadCop": {
        "pre_actions": [
            "{initiator} is using a bad cop approach and telling {target} the horrors of prison."
        ]
    },
    "mixer_social_GoOnTirade_InterrogationTable_BadCop": {
        "pre_actions": [
            "{initiator} is using a bad cop approach and is unleashing a furious tirade, interrogating {target}."
        ]
    },
    "mixer_social_PlayCrazyCop_InterrogationTable_BadCop": {
        "pre_actions": [
            "{initiator} is using a bad cop approach and is playing a game of Crazy Cop with {target}."
        ]
    },
    "mixer_social_DemandAnswers_InterrogationTable_BadCop_Emotion": {
        "pre_actions": [
            "{initiator} is using a bad cop approach and is demanding answers from {target}."
        ]
    },
    "mixer_social_GlareColdly_InterrogationTable_BadCop": {
        "pre_actions": [
            "{initiator} is using a bad cop approach and is glaring coldly at {target}."
        ]
    },
    "mixer_social_Ignore_InterrogationTable_BadCop": {
        "pre_actions": [
            "{initiator} is using a bad cop approach and is deliberately ignoring {target}, giving them the cold shoulder."
        ]
    },
    "mixer_social_DangleHandcuffs_InterrogationTable_BadCop": {
        "pre_actions": [
            "{initiator} is using a bad cop approach and is dangling a pair of handcuffs in front of {target}."
        ]
    },
    "mixer_social_AskForBribe_InterrogationTable_BadCop": {
        "pre_actions": [
            "{initiator} is using a bad cop approach and asking {target} for a bribe."
        ]
    },
    "mixer_social_ShowCrimePictures_InterrogationTable_Evidence": {
        "pre_actions": [
            "{initiator} is using a bad cop approach and is showing {target} a collection of pictures from the crime scene on the interrogation table."
        ]
    },
    ...
    "mixer_social_ShowWitnessStatement_InterrogationTable_Evidence": {
        "pre_actions": [
            "{initiator} is presenting a witness statement to {target} at the interrogation table."
        ]
    },
    ...
    "mixer_social_Retail_BegForSale_Targeted_Friendly_AlwaysOn_STC": {
        "pre_actions": [
            "{initiator} is begging {target} to make a sale in the retail store."
        ]
    },
    "mixer_social_Retail_PressureIntoSale_Targeted_Mean_EmotionSpecific": {
        "pre_actions": [
            "{initiator} is using targeted and forceful tactics to pressure {target} into making a purchase."
        ]
    },
    ...
    "mixer_social_SecretHandshake_Targeted_Friendly_AlwaysOn_Alien": {
        "pre_actions": [
            "{initiator} is doing a secret handshake with {target}."
        ]
    },
    "mixer_social_Targeted_Empathize_Friendly_AlwaysOn_Alien": {
        "pre_actions": [
            "{initiator} is empathizing with {target} who seems upset."
        ]
    },
    "mixer_social_Targeted_TalkAboutHome_Friendly_AlwaysOn_Alien": {
        "pre_actions": [
            "{initiator} is telling {target} about their alien home world."
        ]
    },
    "mixer_social_DiscussWork_Targeted_Friendly_AlwaysOn_coworkers": {
        "pre_actions": [
            "{initiator} is discussing work-related matters with {target}."
        ]
    },
    ...
    "mixer_social_ScareWithProbe_Targeted_Mischief_AlwaysOn_Alien": {
        "pre_actions": [
            "{initiator} is scaring {target} with a probe by using their mischievous alien powers."
        ]
    },
    ...
    "mixer_hospitalExamBed_Exam_ProbeChest": {
        "pre_actions": [
            "{initiator} is carefully scanning {target}'s chest using an exam probe while {target} is lying on the hospital exam bed."
        ]
    },
    ...
    "mixer_social_PlayMirrorGame_Targeted_Funny_AlwaysOn_clone": {
        "pre_actions": [
            "{initiator} is playing a mirror game with {target} where they mimick each others actions."
        ]
    },
    ...
    "mixer_social_CallInferiorVersion_Targeted_Mean_AlwaysOn_clone": {
        "pre_actions": [
            "{initiator} is calling {target} an inferior version of themselves."
        ]
    },
    ...
    "mixer_social_Retail_SureSale_Targeted_Friendly_AlwaysOn_STC": {
        "pre_actions": [
            "{initiator} is finalizing a sure deal with {target}."
        ]
    },
    "mixer_social_AskAboutPriceRange_Targeted_Retail_AlwaysOn": {
        "pre_actions": [
            "{initiator} is asking {target} about the price ranges of the retail items."
        ]
    },
    ...
    "mixer_social_BragAboutPromotion_Targeted_Friendly_AlwaysOn_ActiveCareer": {
        "pre_actions": [
            "{initiator} is bragging to {target} about their recent promotion in their career."
        ]
    },
    "mixer_social_CongratulateOnPromotion_Targeted_Friendly_AlwaysOn_ActiveCareer": {
        "pre_actions": [
            "{initiator} is giving heartfelt congratulations to {target} on their promotion."
        ]
    },
    "mixer_social_AskAboutSalary_Targeted_Friendly_AlwaysOn_ActiveCareer": {
        "pre_actions": [
            "{initiator} is asking {target} about their salary."
        ]
    },
    "mixer_social_DiscussCase_Targeted_Friendly_AlwaysOn_ActiveCareer": {
        "pre_actions": [
            "{initiator} is discussing a career-related case with {target}."
        ]
    },
    ...
    "mixer_Social_EnthuseAboutInventions_targeted_Friendly_alwaysOn_ActiveCareer": {
        "pre_actions": [
            "{initiator} is excitedly talking to {target} about their latest inventions."
        ]
    },
    ...
    "mixer_social_InsultWorkEthic_Targeted_Mean_AlwaysOn_ActiveCareer": {
        "pre_actions": [
            "{initiator} is insulting {target}'s work ethic."
        ]
    },
    "mixer_social_SpoilLatestEpisode_Targeted_Mean_AlwaysOn_ActiveCareer": {
        "pre_actions": [
            "{initiator} is maliciously spoiling the latest episode of a season for {target}."
        ]
    },
    "mixer_social_PretendToFire_Targeted_Mean_AlwaysOn_ActiveCareer": {
        "pre_actions": [
            "{initiator} is pretending to fire {target} from their job."
        ]
    },
    "mixer_social_FlirtCovertly_Targeted_Romance_AlwaysOn_ActiveCareer": {
        "pre_actions": [
            "{initiator} is covertly flirting with {target} in a subtle and discreet manner."
        ]
    },
    "mixer_social_JokeAboutCoworkers_Targeted_Funny_AlwaysOn_ActiveCareer": {
        "pre_actions": [
            "{initiator} is telling a joke about co-workers to {target}."
        ]
    },
    "mixer_social_TellNSFWJoke_Targeted_Funny_AlwaysOn_ActiveCareer": {
        "pre_actions": [
            "{initiator} is telling a joke that would be inappropriate for work to {target}."
        ]
    },
    ...
    "mixer_social_Targeted_AskAboutParty_Friendly_AlwaysOn_Alien": {
        "pre_actions": [
            "{initiator} is asking {target} about partying."
        ]
    },
    ...
    "mixer_social_DiscussPressurePoints_Targeted_Friendly_AlwaysOn_MassageTherapist": {
        "pre_actions": [
            "{initiator} is discussing pressure points with {target}."
        ]
    },
    "mixer_social_AskAboutMassageBenefits_Targeted_Friendly_AlwaysOn_MassageTherapist": {
        "pre_actions": [
            "{initiator} is asking {target} about the benefits of a massage."
        ]
    },
    "mixer_social_AskForFlexibilityTips_Targeted_Friendly_AlwaysOn_YogaInstructor": {
        "pre_actions": [
            "{initiator} is asking {target} for tips on improving flexibility in yoga."
        ]
    },
    "mixer_social_ChatAboutYogaClass_Targeted_Friendly_AlwaysOn_Yoga": {
        "pre_actions": [
            "{initiator} is discussing yoga class with {target}."
        ]
    },
    ...
    "mixer_Social_RequestHandMassage_Targeted_Friendly_AlwaysOn_Reflexologist": {
        "pre_actions": [
            "{initiator} is requesting a hand massage from {target}."
        ]
    },
    ...
    "mixer_social_AskAboutReflexPoints_Targeted_Friendly_alwaysOn_reflexologist": {
        "pre_actions": [
            "{initiator} is asking {target} about reflex points."
        ]
    },
    ...
    "mixer_YogaMat_Corpse_SleepExit_YogaClass": {
        "pre_actions": [
            "{initiator} is lying down in the Corpse Pose on the Yoga Mat."
        ]
    },
    ...
    "mixer_YogaMat_Corpse_NormalExit_YogaClass_Mirrored": {
        "pre_actions": [
            "{initiator} is lying down on a yoga mat in a corpse pose during a normal exit from a yoga class."
        ]
    },
    "mixer_YogaMat_Corpse_SleepExit_YogaClass_Mirrored": {
        "pre_actions": [
            "{initiator} is lying down in the Corpse Pose on a Yoga Mat, appearing as if they are sleeping."
        ]
    },
    ...
    "mixer_Social_Clubs_NT_ComplainAboutClubLeader": {
        "pre_actions": [
            "{initiator} is expressing their dissatisfaction about the current leader of the club to {target}."
        ]
    },
    ...
    "mixer_social_Closet_MakeOut_targeted_romance_highScore": {
        "pre_actions": [
            "{initiator} and {target} are passionately making out in the closet."
        ]
    },
    "mixer_social_targeted_friendly_MiddleScore_SeeOutfit_Everyday": {
        "pre_actions": [
            "{initiator} is complimenting {target} on their everyday outfit."
        ]
    },
    "mixer_social_targeted_friendly_MiddleScore_SeeOutfit_Formal": {
        "pre_actions": [
            "{initiator} is complimenting {target}'s formal outfit."
        ]
    },
    "mixer_social_targeted_friendly_MiddleScore_SeeOutfit_Athletic": {
        "pre_actions": [
            "{initiator} is complimenting {target}'s workout outfit."
        ]
    },
    "mixer_social_targeted_friendly_MiddleScore_SeeOutfit_Swim": {
        "pre_actions": [
            "{initiator} is complimenting {target}'s swimwear."
        ]
    },
    "mixer_social_targeted_friendly_MiddleScore_SeeOutfit_Sleep": {
        "pre_actions": [
            "{initiator} is complimenting {target}'s sleepwear."
        ]
    },
    "mixer_social_targeted_friendly_MiddleScore_SeeOutfit_Party": {
        "pre_actions": [
            "{initiator} is complimenting {target} party outfit."
        ]
    },
    "mixer_social_DiscussDJMusic_targeted_Friendly_alwaysOn_STC": {
        "pre_actions": [
            "{initiator} and {target} are discussing DJ techniques and music."
        ]
    },
    ...
    "mixer_social_AskAboutClubs_Targeted_Friendly_AlwaysOn_Clubs": {
        "pre_actions": [
            "{initiator} is asking {target} about clubs clubs they are in."
        ]
    },
    "mixer_social_targeted_TalkAboutParty_Trait_DanceMachine": {
        "pre_actions": [
            "{initiator}  is discussing the latest party with a dance machine with {target}."
        ]
    },
    ...
    "mixer_DJBooth_GiveTipToPlayer": {
        "pre_actions": [
            "{initiator} is giving a tip to {target}, the DJ."
        ]
    },
    "mixer_social_DiscussDanceTechnique_targeted_Friendly_alwaysOn_STC": {
        "pre_actions": [
            "{initiator} is discussing dance techniques with {target}."
        ]
    },
    ...
    "mixer_social_targeted_friendly_MiddleScore_SeeOutfit_ColdOutfit": {
        "pre_actions": [
            "{initiator} is complimenting {target} on their cold weather outfit."
        ]
    },
    "mixer_social_targeted_friendly_MiddleScore_SeeOutfit_HotOutfit": {
        "pre_actions": [
            "{initiator} is complimenting {target} on their hot weather outfit."
        ]
    },
    ...
    "mixer_socials_ComplainAboutDish_Targeted_Friendly_AlwaysOn_DiningSocials": {
        "pre_actions": [
            "{initiator} is complaining about the dish they are eating to {target}."
        ]
    },
    ...
    "mixer_social_ComplainAboutFoodPoisoning_Targeted_Friendly_AlwaysOn": {
        "pre_actions": [
            "{initiator} is complaining to {target} about experiencing food poisoning."
        ]
    },
    ...
    "mixer_social_AskToDeliverCompliment_Targeted_Friendly_AlwaysOn_WaitStaff": {
        "pre_actions": [
            "{initiator} is asking {target} to deliver a compliment to the chefs."
        ]
    },
    "mixer_social_AskToDeliverInsult_Targeted_Friendly_AlwaysOn_WaitStaf": {
        "pre_actions": [
            "{initiator} is requesting {target} and the wait staff to deliver an insult to the chefs."
        ]
    },
    ...
    "mixer_socials_DiscussScene_targeted_Friendly_Movie_AlwaysOn_STC": {
        "pre_actions": [
            "{initiator} is discussing the movie scene with {target}."
        ]
    },
    ...
    "mixer_socials_ComplainAboutActor_targeted_Friendly_Movie_AlwaysOn_STC": {
        "pre_actions": [
            "{initiator} is complaining about an actor in the movie to {target}."
        ]
    },
    "mixer_socials_ComplainAboutDirector_targeted_Friendly_Movie_AlwaysOn_STC": {
        "pre_actions": [
            "{initiator} is complaining about the director in the movie to {target}."
        ]
    },
    "mixer_social_UltimatePickUp_targeted_romance_AlwaysOn": {
        "pre_actions": [
            "{initiator} is confidently using the ultimate pick-up line with {target}."
        ]
    },
    "mixer_social_UltimatePickUp_targeted_romance_AlwaysOn_teen": {
        "pre_actions": [
            "{initiator} is confidently using the ultimate pick-up line on {target}."
        ]
    },
    ...
    "mixer_socials_AskToTrade_Targeted_Friendly_AlwaysOn_STC": {
        "pre_actions": [
            "{initiator} is asking {target} to trade Voidcritters."
        ]
    },
    "mixer_socials_AskToTrade_FromPicker_Friendly_AlwaysOn_STC": {
        "pre_actions": [
            "{initiator} is asking {target} if they want to trade Voidcritters."
        ]
    },
    ...
    "mixer_social_DebateExistenceOfVampires_Targeted_Friendly_AlwaysOn": {
        "pre_actions": [
            "{initiator} is debating the existence of vampires with {target}."
        ]
    },
    ...
    "mixer_social_AskForAdviceOnBitingTechnique_Targeted_Friendly_AlwaysOn": {
        "pre_actions": [
            "{initiator} is asking {target} for advice on improving their biting technique."
        ]
    },
    ...
    "mixer_social_OfferToCureVampirism_Targeted_Friendly": {
        "pre_actions": [
            "{initiator} is offering to cure {target}'s vampirism."
        ]
    },
    ...
    "mixer_social_Fight_targeted_mean_VampireAndSim_Duel_WithGarlic": {
        "pre_actions": [
            "{initiator} is fighting with {target}, armed with garlic and ready to dual a vampire."
        ]
    },
    ...
    "mixer_social_RequestVampiricTraining_Targeted_Friendly_AlwaysOn": {
        "pre_actions": [
            "{initiator} is requesting {target}'s assistance in vampiric training."
        ]
    },
    ...
    "mixer_social_Fight_targeted_mean_VampireAndSim_Duel_DarkForm_WithGarlic": {
        "pre_actions": [
            "{initiator} is engaging in a fight with {target}, resulting in a mean and intense confrontation. {initiator}, being a vampire, is transforming into their dark form and is challenging {target} to a duel. However, {target} is coming prepared with garlic to defend themselves."
        ]
    },
    ...
    "mixer_social_Vampire_MockMortality_Targeted_Mean_AlwaysOn": {
        "pre_actions": [
            "{initiator}, a vampire, is cruelly mocking {target}'s mortality."
        ]
    },
    ...
    "mixer_social_Vampire_MakeVampirePun_Targeted_Funny_AlwaysOn": {
        "pre_actions": [
            "{initiator} is playfully making a vampire pun, targeting {target}."
        ]
    },
    ...
    "mixer_social_PoliteIntroduction_greetings_skills": {
        "pre_actions": [
            "{initiator} is introducing themselves to {target} with a polite greeting."
        ]
    },
    ...
    "mixer_social_ThrowShade_Mean_AlwaysOn_Teen": {
        "pre_actions": [
            "{initiator} is throwing shade at {target}."
        ]
    },
    ...
    "mixer_social_AskAboutNegativeMood_Targeted_Friendly_AlwaysOn": {
        "pre_actions": [
            "{initiator} is asking {target} about their mood with genuine concern."
        ]
    },
    ...
    "mixer_social_MendDifferences_targeted_friendly_alwaysOn": {
        "pre_actions": [
            "{initiator} is mending any differences with {target}."
        ]
    },
    ...
    "mixer_social_SincereApology_targeted_friendly_lowScore": {
        "pre_actions": [
            "{initiator} is sincerely apologizing to {target}."
        ]
    },
    ...
    "mixer_social_MakeFunnyFaces": {
        "pre_actions": [
            "{initiator} is making funny faces at {target}."
        ]
    },
    ...
    "mixer_social_MakeFunnyFaces_Toddler": {
        "pre_actions": [
            "{initiator} making funny faces with {target}."
        ]
    },
    ...
    "mixer_social_CraftSalesTable_AskAboutNewStock": {
        "pre_actions": [
            "{initiator} is asking {target} about the new stock at the Craft Sales Table."
        ]
    },
    ...
    "mixer_Social_Investigation_Act1_QuestionAboutLab": {
        "pre_actions": [
            "{initiator} is requesting evidence from {target} about the secret lab for their investigation."
        ]
    },
    "mixer_Social_Investigation_Act1_RequestKeycard": {
        "pre_actions": [
            "{initiator} is politely asking {target} to borrow a keycard for an investigation."
        ]
    },
    "mixer_Social_Investigation_Act1_QuestionAboutBase": {
        "pre_actions": [
            "{initiator} is requesting evidence from the military base for their investigation."
        ]
    },
    ...
    "mixer_Social_Investigation_Act1_QuestionAboutMilitaryOperations": {
        "pre_actions": [
            "{initiator} is requesting evidence from {target} about the StrangerVille mystery and inquiring about the military operations in Act 1."
        ]
    },
    ...
    "mixer_Social_Investigation_Act2_TalkAboutSpores": {
        "pre_actions": [
            "{initiator} is discussing spores with {target} in the lab."
        ]
    },
    "mixer_Social_Investigation_Act2_AskToCraftFilter": {
        "pre_actions": [
            "{initiator} is requesting {target} to craft a Spore Filter for an investigation."
        ]
    },
    ...
    "mixer_Social_Investigation_Act3_Recruit": {
        "pre_actions": [
            "{initiator} is recruiting {target} for the fight against the Mother Plant."
        ]
    },
    ...
    "mixer_Social_Possessed_ChatP2P_ConfessFearOfHumans": {
        "pre_actions": [
            "{initiator} is confessing their fear of humans with {target}."
        ]
    },
    ...
    "mixer_Social_Possessed_ChatP2P_Chat": {
        "pre_actions": [
            "{initiator} is chatting wwith {target}."
        ]
    },
    ...
    "mixer_Social_MilitaryCareer_Recruit": {
        "pre_actions": [
            "{initiator} is recruiting {target} into the military."
        ]
    },
    ...
    "mixer_Social_Investigation_Act1_QuestionAboutBaseOrLab": {
        "pre_actions": [
            "{initiator} is questioning {target} about the military base to gather information for an investigation."
        ]
    },
    "mixer_Social_Investigation_Act3_Recruit_DisplayOnly": {
        "pre_actions": [
            "{initiator} is investigating {target}'s skills and abilities for potential recruitment against the Mother Plant."
        ]
    },
    ...
    "mixer_social_MilitaryIntroduction_greetings": {
        "pre_actions": [
            "{initiator}, in their military uniform, is formally introducing and greeting {target}."
        ]
    },
    ...
    "mixer_Social_WitchOccult_MagicTraining_Request": {
        "pre_actions": [
            "{initiator} is asking {target} an experienced witch, for magical training."
        ]
    },
    "mixer_Social_WitchOccult_RiteOfDissolution_Request": {
        "pre_actions": [
            "{initiator} is asking {target} for the Rite of Dissolution."
        ]
    },
    "mixer_Social_WitchOccult_RiteOfAscension_Request": {
        "pre_actions": [
            "{initiator} is asking {target} about the Rite of Ascension."
        ]
    },
    ...
    "mixer_Social_Batuu_Hondo_AskAboutMissingCredits": {
        "pre_actions": [
            "{initiator} is asking {target} about missing credits."
        ]
    },
    ...
    "mixer_Social_Batuu_SNPC_Kylo_QuestionLoyalty": {
        "pre_actions": [
            "{initiator} is questioning the loyalty of Kylo."
        ]
    },
    ...
    "mixer_social_Fight_targeted_mean_RecruitToFO_ResistanceTarget_FR3": {
        "pre_actions": [
            "{initiator} is fighting with {target}, using mean tactics in an attempt to recruit them to the Freelancer Resistance Faction."
        ]
    },
    ...
    "mixer_social_MakeSmallTalk_targeted_Friendly_alwaysOn": {
        "pre_actions": [
            "{initiator} is engaging in small talk with {target}."
        ]
    },
    "mixer_PerformanceSpace_solicitTip": {
        "pre_actions": [
            "{initiator} is soliciting tips from {target} for their performance."
        ]
    },
    ...
    "mixer_social_ComplainAboutLoudNoises_targeted_Mean_alwaysOn_apartmentNeighbor": {
        "pre_actions": [
            "{initiator} is angrily complaining to {target} about the loud noises they are making as a neighbor."
        ]
    },
    ...
    "mixer_Social_Friendly_VideoGameConsole_Lose2Win": {
        "pre_actions": [
            "{initiator} is congratulating {target} on their joint victory on the video game console."
        ]
    },
    ...
    "mixer_social_BragCurryContest_Targeted_Friendly_AlwaysOn": {
        "pre_actions": [
            "{initiator} excitedly brags to {target} about being the reigning Curry Champion."
        ]
    },
    "mixer_social_AskAboutRomanticDestiny_targeted_Friendly_AlwaysOn_LoveGuru": {
        "pre_actions": [
            "{initiator} is asking {target} about their romantic destiny, seeking guidance from a Love Guru."
        ]
    },
    "mixer_social_RequestGuruLoveWisdom_targeted_Friendly_AlwaysOn_LoveGuru": {
        "pre_actions": [
            "{initiator} is requesting wisdom and advice on love matters from {target}, the Romance Guru."
        ]
    },
    "mixer_social_AskGuruAboutCurrentRelationship_targeted_Friendly_AlwaysOn_LoveGuru": {
        "pre_actions": [
            "{initiator} is asking Love Guru {target} for advice on their current relationship."
        ]
    },
    "mixer_social_AskAboutRomanticDestiny_Targeted_Friendly_AlwaysOn_LoveGuru_Initiate": {
        "pre_actions": [
            "{initiator} is asking {target} about their romantic destiny and seeking advice from the Love Guru."
        ]
    },
    "mixer_social_RequestGuruLoveWisdom_Targeted_Friendly_AlwaysOn_STC_LoveGuru_Initiate": {
        "pre_actions": [
            "{initiator} is seeking {target}'s wisdom as a Love Guru."
        ]
    },
    "mixer_social_AskGuruAboutCurrentRelationship_Targeted_Friendly_AlwaysOn_STC_LoveGuru_Initiate": {
        "pre_actions": [
            "{initiator} is asking the Love Guru {target} for advice on their current relationship."
        ]
    },
    "mixer_Social_RantAboutShow_Targeted_Friendly_AlwaysOn_STC_LogicFestival": {
        "pre_actions": [
            "{initiator} is ranting about the show with {target} at the logic festival."
        ]
    },
    ...
    "mixer_Socials_JokeAboutRocketWoohoo_Targeted_Funny_AlwaysOn_STC_LogicFestival": {
        "pre_actions": [
            "{initiator} is playfully telling a hilarious joke to {target} about sex on a rocket ship."
        ]
    },
    "mixer_social_Career_Activist_MakeEmptyPromises_alwaysOn": {
        "pre_actions": [
            "{initiator} making empty promises as an activist to {target}."
        ]
    },
    "mixer_Social_SelfieWithCosplayer_Targeted_Friendly_AlwaysOn_STC_LogicFestival": {
        "pre_actions": [
            "{initiator} is asking {target} the cosplayer if they can take a selfie together."
        ]
    },
    ...
    "mixer_Social_Targeted_PetToPet_Greeting_Hostile": {
        "pre_actions": [
            "{initiator} is greeting {target} in a hostile manner."
        ]
    },
    ...
    "mixer_Social_Targeted_PetToPet_Greeting_Friendly": {
        "pre_actions": [
            "{initiator} is greeting {target} in a friendly manner."
        ]
    },
    "mixer_Social_Targeted_PetToPet_Greeting_Neutral": {
        "pre_actions": [
            "{initiator} is greeting {target}."
        ]
    },
    ...
    "mixer_Social_Friendly_DeclareWeatherLove_Snow": {
        "pre_actions": [
            "{initiator} is declaring their love for the snow to {target}."
        ]
    },
    ...
    "mixer_social_WeatherTemperatureSocials_ComplainAboutRain": {
        "pre_actions": [
            "{initiator} is complaining to {target} about the rain."
        ]
    },
    ...
    "mixer_BeeBox_CollectSwarm": {
        "pre_actions": [
            "{initiator} is collecting a swarm of bees from the BeeBox."
        ]
    },
    ...
    "mixer_BeeBox_SellHoney": {
        "pre_actions": [
            "{initiator} is harvesting honey from the BeeBox to sell to {target}."
        ]
    },
    ...
    "mixer_social_FeudBringer_EndFeud_targeted_Friendly_alwaysOn": {
        "pre_actions": [
            "{initiator} is declaring an end to the feud with {target}."
        ]
    },
    ...
    "mixer_social_Squad_AskForCompliment_targered_Friendly_alwaysOn": {
        "pre_actions": [
            "{initiator} is asking {target} for a compliment."
        ]
    },
    ...
    "mixer_social_Mermaid_AskIfMerfolk_Friendly": {
        "pre_actions": [
            "{initiator} is asking {target} if they are a merfolk."
        ]
    },
    ...
    "mixer_Dolphin_Trick_Fetch": {
        "pre_actions": [
            "{initiator} is throwing a toy for {target} to fetch, and {target} is eagerly retrieving it as a dolphin trick."
        ]
    },
    ...
    "mixer_social_WooHooInIslandWaterfall_targeted_romance_transition": {
        "pre_actions": [
            "{initiator} and {target} are sneaking into the secluded island waterfall to have sex."
        ]
    },
    ...
    "mixer_social_JuiceKeg_ImTheBest_Friendly_alwaysOn": {
        "pre_actions": [
            "{initiator} is confidently boasting about being the best while enjoying a drink from the Juice Keg to {target}."
        ]
    },
    ...
    "mixer_Social_Education_AskDonation": {
        "pre_actions": [
            "{initiator} is politely asking {target} for a donation to support education."
        ]
    },
    ...
    "mixer_CollegeOrganizations_AskToJoinOrQuit_Art": {
        "pre_actions": [
            "{initiator} is asking {target} to join the College Art Society."
        ]
    },
    "mixer_CollegeOrganizations_AskToJoinOrQuit_Debate": {
        "pre_actions": [
            "{initiator} is asking {target} about joining the Debate Guild."
        ]
    },
    ...
    "mixer_CollegeOrganizations_AskToJoinOrQuit_Robotics": {
        "pre_actions": [
            "{initiator} is asking {target} to join the Bot Savants."
        ]
    },
    "mixer_social_DiscussFavoriteArtPieces_targeted_Friendly_alwaysOn_STC": {
        "pre_actions": [
            "{initiator} is discussing favorite art pieces with {target}."
        ]
    },
    ...
    "mixer_social_AskAboutInspiration_Friendly": {
        "pre_actions": [
            "{initiator} is asking {target} about their inspiration."
        ]
    },
    ...
    "mixer_social_Friendly_CollegeOrganizations_Debate_OfferFeedback": {
        "pre_actions": [
            "{initiator} is offering {target} friendly feedback on their debate performance."
        ]
    },
    ...
    "mixer_CollegeOrganizations_AskToJoinOrQuit_Party": {
        "pre_actions": [
            "{initiator} is asking {target}, a member of the Foxbury Spirit Squad, to join the college organization."
        ]
    },
    ...
    "mixer_Social_CivicPolicy_RepealPolicy_GetSignature": {
        "pre_actions": [
            "{initiator} is politely asking {target} to sign a petition."
        ]
    },
    ...
    "mixer_social_WooHooInDumpster_targeted_romance_transition": {
        "pre_actions": [
            "{initiator} is climbing into a dumpster with {target} to have sex."
        ]
    },
    "mixer_Social_RecyclingGuru_AskForTips": {
        "pre_actions": [
            "{initiator} is asking the Recycling Guru, {target}, for some recycling tips."
        ]
    },
    "mixer_Social_RecyclingGuru_AskForMaterials": {
        "pre_actions": [
            "{initiator} is asking {target}, a known recycling guru, for any extra recycling materials to spare."
        ]
    },
    ...
    "mixer_Social_CivicPolicy_ConvinceToInstall_GreenGardening_Planter": {
        "pre_actions": [
            "{initiator} is discussing civic policies with {target} and convincing them to install planters for green gardening."
        ]
    },
    ...
    "mixer_Social_CivicPolicy_BragAbout_Planter": {
        "pre_actions": [
            "{initiator} is bragging to {target} about their impressive collection of planters."
        ]
    },
    ...
    "mixer_social_Fight_targeted_CivicPolicy_Aggression": {
        "pre_actions": [
            "{initiator} is fighting with {target} expressing their differing opinions on civil policy."
        ]
    },
    "mixer_social_Fight_targeted_CivicPolicy_Aggression_Transition": {
        "pre_actions": [
            "{initiator} and {target} are engaging in a heated argument, fueled by differing opinions on civic policy."
        ]
    },
    ...
    "mixer_socials_ChatAboutRadSlope_Targeted_Friendly_Snowboarding": {
        "pre_actions": [
            "{initiator} is discussing the rad slope they just went down with {target} while snowboarding."
        ]
    },
    ...
    "mixer_Social_Lifestyles_ShareLifestyleTips_FrequentTravleer": {
        "pre_actions": [
            "{initiator} is sharing frequent traveler lifestyle tips with {target}."
        ]
    },
    ...
    "mixer_social_RespectfulIntroduction_greetings": {
        "pre_actions": [
            "{initiator} is respectfully introducing themselves to {target}."
        ]
    },
    ...
    "mixer_social_TryForBabyInCave_targeted_romance_transition": {
        "pre_actions": [
            "{initiator} and {target} are sneaking into the private cave to try for a baby."
        ]
    },
    ...
    "mixer_social_Laundry_Targeted_EmotionSpecific_SmellFoul": {
        "pre_actions": [
            "{initiator} is sniffing {target}'s foul-smelling laundry."
        ]
    },
    "mixer_social_Targeted_Friendly_MiddleScore_STC_WhatsThatSpot_Child": {
        "pre_actions": [
            "{initiator} is inquiring about a spot on {target}'s clothing."
        ]
    },
    "mixer_social_Targeted_Friendly_AlwaysOn_STC_AskAbout_RodentDisease": {
        "pre_actions": [
            "{initiator} is asking {target} about Rabid Rodent Fever."
        ]
    },
    ...
    "mixer_Social_HighSchool_Active_TalkToTeacher": {
        "pre_actions": [
            "{initiator} is talking to their teacher, {target}."
        ]
    },
    ...
    "mixer_social_ConvinceToJoinTeam_Targeted_Friendly_AlwaysOn_Teens": {
        "pre_actions": [
            "{initiator} is convincing {target} to join their team."
        ]
    },
    ...
    "mixer_Social_Targeted_Friendly_OpenableWindow_AskForPermission": {
        "pre_actions": [
            "{initiator} is asking {target} for permission to attend an event."
        ]
    },
    "mixer_social_HighSchoolFestival_RequestScienceFair": {
        "pre_actions": [
            "{initiator} is requesting {target} to participate in the Science Fair at the High School Festival."
        ]
    },
    ...
    "mixer_social_PartyAnimal_VibeCheck": {
        "pre_actions": [
            "{initiator} is giving {target} a vibe check."
        ]
    },
    ...
    "mixer_Social_Fear_Failing_Class_AskForExtraCredit": {
        "pre_actions": [
            "{initiator} is nervously asking {target} about the possibility of extra credit to prevent class failure."
        ]
    },
    ...
    "mixer_socials_SwapBabyMilestoneStories_Targeted_Friendly_AlwaysOn_STC": {
        "pre_actions": [
            "{initiator} is excitedly swapping baby milestone stories with {target}."
        ]
    },
    ...
    "mixer_Social_BabyShower_AskIfExcitedToBeSibling": {
        "pre_actions": [
            "{initiator} is asking {target} at the baby shower if they are excited to become a big sibling."
        ]
    },
    "mixer_social_BayArea_NPC_baygossip_Targeted_Friendly_AlwaysOn": {
        "pre_actions": [
            "{initiator} is taking {target} aside and sharing some juicy secrets about San Sequoia, a popular destination in the Bay Area."
        ]
    },
    ...
    "mixer_Social_BabyShower_SuggestBabyName": {
        "pre_actions": [
            "{initiator} is suggesting a baby name {target} at the baby shower."
        ]
    },
    ...
    "mixer_Social_BabyShower_AskIfExcitedToBeSibling_Toddler": {
        "pre_actions": [
            "{initiator} is asking {target} at the baby shower if they are excited to be a big sibling."
        ]
    },
    ...
    "mixer_socials_Toddler_TalkAbouts_CrossAge_Interactions_FavoriteGame": {
        "pre_actions": [
            "{initiator} is talking about their favorite games with {target}."
        ]
    },
    ...
    "mixer_socials_Toddler_Friendly_CrossAge_Interactions_SingSong": {
        "pre_actions": [
            "{initiator} is singing a song with {target}."
        ]
    },
    ...
    "mixer_social_trait_HorseLover_ShareDetailedHorseFacts_targeted_Friendly_alwaysOn_child": {
        "pre_actions": [
            "{initiator} enthusiastically shares detailed horse facts with {target}."
        ]
    },
    ...
    "Mixer_social_TellJoke_group_Funny_alwaysOn_child_HorseLover_TellJokeAboutHorseButts": {
        "pre_actions": [
            "{initiator} is telling a joke about horse butts to {target}."
        ]
    },
    ...
    "mixer_social_Wedding_WeddingTradition_AskToComeToWedding": {
        "pre_actions": [
            "{initiator} is asking {target} if they want to come to the wedding."
        ]
    },
    "mixer_social_Wedding_Bouquet_AskAbout": {
        "pre_actions": [
            "{initiator} is asking {target} about the flower bouquet."
        ]
    },
    ...
    "mixer_social_WeddingToast_AskToMakeToast": {
        "pre_actions": [
            "{initiator} is asking {target} to make a wedding toast."
        ]
    },
    ...
    "mixer_social_AskToBeRingBearer": {
        "pre_actions": [
            "{initiator} is asking {target} to be the ring bearer at the wedding."
        ]
    },
    ...
    "mixer_social_JokeAboutMarriage_ActorEngaged": {
        "pre_actions": [
            "{initiator} is playfully making a joke about marriage to {target}."
        ]
    },
    "mixer_social_FriendlyIntroduction_greetings_Werewolf": {
        "pre_actions": [
            "{initiator} is sniffing {target} curiously and introducing themselves."
        ]
    },
    ...
    "mixer_socials_TellJoke_group_Funny_alwaysOn_Werewolf": {
        "pre_actions": [
            "{initiator} is telling a joke about werewolves to {target} and anyone else listening."
        ]
    },
    ...
    "mixer_social_Insult_Mean_STC_Werewolf": {
        "pre_actions": [
            "{initiator} is mocking {target}'s feeble nature, making mean-spirited comments about their weakness."
        ]
    },
    ...
    "mixer_Social_WerewolfPack_AskAboutPacks_Region": {
        "pre_actions": [
            "{initiator} is asking {target} about the werewolf packs in the region."
        ]
    },
    ...
    "mixer_social_Fight_targeted_mean_WerewolfToSim": {
        "pre_actions": [
            "{initiator} is fighting with {target}."
        ]
    },
    ...
    "mixer_Social_Targeted_Friendly_AlwaysOn_Werewolf_AskToSpar": {
        "pre_actions": [
            "{initiator} asking {target} if they want to spar."
        ]
    },
    "mixer_Social_Targeted_Friendly_AlwaysOn_Werewolf_AskToSpar_AtRing": {
        "pre_actions": [
            "{initiator} is asking {target} if they want to spar in the ring."
        ]
    },
    ...
    "mixer_Social_Targeted_Friendly_AlwaysOn_WerewolfPack_JoinTrial_AskToSpar": {
        "pre_actions": [
            "{initiator}, a member of the Werewolf Pack, is asking {target} to participate in a trial spar."
        ]
    },
    "mixer_Social_WerewolfPack_EndFeud": {
        "pre_actions": [
            "{initiator}, from the Werewolf Pack, is asking {target} to end their feud."
        ]
    },
    ...
    "mixer_social_WhisperSeductively_targeted_romance_middleScore_Werewolf_F": {
        "pre_actions": [
            "{initiator} is whispering seductively to {target}, using a low, growling tone."
        ]
    },
    "mixer_Social_Targeted_Friendly_AlwaysOn_Werewolf_AskToSpar_Commanded": {
        "pre_actions": [
            "{initiator} is asking {target} they would like to spar."
        ]
    },
    ...
    "mixer_socials_GiveTheWerewolfTalk_Targeted_Friendly_AlwaysOn_STC": {
        "pre_actions": [
            "{initiator} is giving the werewolf talk with {target}."
        ]
    },
    ...
    "mixer_Social_WerewolfPack_AskAboutRank": {
        "pre_actions": [
            "{initiator} is asking {target} about their pack rank to understand their status within the werewolf pack."
        ]
    },
    "mixer_Social_WerewolfPack_AskToBePackMentored": {
        "pre_actions": [
            "{initiator} is asking {target} for mentorship to become a member of the werewolf pack."
        ]
    },
